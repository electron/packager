...
test('platform=mas and arch=universal with a supported official Electron version', testMultiTarget({ arch: 'universal', platform: 'mas', electronVersion: '12.0.0' }, 1, 'Package should be generated for mas/universal'))
